...
import { AuthService, PhysicianService } from "service-lib";
...
@Component({
  selector: "physician-addstep2",
  templateUrl: "./physician-addstep2.component.html"
})
export class OrgPhysicianAddStep2Component implements OnInit, OnChanges {
